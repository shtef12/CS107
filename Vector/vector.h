...
typedef struct {
    int initialAllocSize;
    int allocatedLen;               //length allocated for the vector
    int logicalLen;                 //number of elements in vector
    int elementSize;                //size of the elements
    void *elements;                 //elements in vector
    void (*freefn)(void *); //function to free elements in vector
} vector;
